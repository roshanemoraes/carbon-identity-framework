...
public class SQLConstants {
    ...
    public static final String GET_OPERATIONS_TAIL_ORACLE = " ORDER BY CREATED_AT DESC FETCH FIRST :LIMIT; ROWS ONLY";

    public static final String GET_OPERATIONS_TAIL_MSSQL = " ORDER BY CREATED_AT DESC OFFSET 0 ROWS " +
    ...
    public static final String GET_UNIT_OPERATIONS_TAIL_ORACLE = " ORDER BY CREATED_AT DESC FETCH FIRST :LIMIT; " +
            "ROWS ONLY";

    public static final String GET_UNIT_OPERATIONS_TAIL_MSSQL = " ORDER BY CREATED_AT DESC OFFSET 0 ROWS " +
            "FETCH NEXT :LIMIT; ROWS ONLY";
    ...
    public static final String GET_UNIT_OPERATION = "SELECT U.UNIT_OPERATION_ID, U.OPERATION_ID, " +
            ...
            "FROM IDN_ASYNC_OPERATION_STATUS_UNIT U JOIN IDN_ASYNC_OPERATION_STATUS S ON U.OPERATION_ID = S.ID " +
            "WHERE UNIT_OPERATION_ID = :UNIT_OPERATION_ID; AND INITIATED_ORG_ID = :INITIATED_ORG_ID;";
