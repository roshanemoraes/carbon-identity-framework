...
import org.wso2.carbon.identity.framework.async.status.mgt.api.service.AsyncOperationStatusMgtService;
import org.wso2.carbon.identity.framework.async.status.mgt.internal.component.AsyncOperationStatusMgtDataHolder;
import org.wso2.carbon.identity.framework.async.status.mgt.internal.dao.AsyncOperationStatusMgtDAO;
import org.wso2.carbon.identity.framework.async.status.mgt.internal.dao.impl.AsyncOperationOperationStatusMgtDAOImpl;
...
import static org.wso2.carbon.identity.framework.async.status.mgt.internal.util.AsyncOperationStatusMgtExceptionHandler.handleClientException;
...
public class AsyncOperationStatusMgtServiceImpl implements AsyncOperationStatusMgtService {
    ...
    private static final AsyncOperationStatusMgtServiceImpl INSTANCE = new AsyncOperationStatusMgtServiceImpl();
    private static OrganizationManager organizationManager = AsyncOperationStatusMgtDataHolder.getInstance()
